...
# The `kv_format` argument of flash_mla_with_kvcache, needed because V3.2-no-RoPE and V4.1 are both 528 B per token
KVCACHE_LAYOUT_TO_KV_FORMAT = {
    None: None,
    quant.KVCacheLayout.V32_FP8Sparse: "V32",
    quant.KVCacheLayout.V32_NO_ROPE_FP8Sparse: "V32_NO_ROPE",
    quant.KVCacheLayout.V4_FP8Sparse: "V4",
    quant.KVCacheLayout.V41_FP8Sparse: "V41",
    quant.KVCacheLayout.V41_FP4: "V41_FP4",
}
...
class ExtraTestParamForDecode:
    ...
    kvcache_layout: Optional["quant.KVCacheLayout"] = None          # Must be specified for d_qk == 512 to distinguish V4 / V41 / V41_FP4 / V32_NO_ROPE
...
def run_flash_mla_decode(p: TestParam, t: TestcaseForDecode, tile_scheduler_metadata, num_splits):
    ...
    return flash_mla.flash_mla_with_kvcache(
        ...
        KVCACHE_LAYOUT_TO_KV_FORMAT[t.kv_scope.kvcache_layout]
    )
...
def count_flop_and_mem_vol_for_decode(p: TestParam, t: TestcaseForDecode) -> FlopsAndMemVolStatisticsForDecode:
    ...
    kv_token_size = t.kv_scope.kvcache_layout.get_bytes_per_token()   # Assume FP8 KV Cache
    mem_vol = sum([
