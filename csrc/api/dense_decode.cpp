...
dense_attn_decode_interface(
    ...
    if (q_dtype == torch::kBFloat16) {
        DISPATCH_HEAD_DIM(head_size_k, kHeadDimK, [&] {
            sm90::decode::dense::run_flash_splitkv_mla_kernel<cutlass::bfloat16_t, kHeadDimK>(params);
        });
...
#else
        DISPATCH_HEAD_DIM(head_size_k, kHeadDimK, [&] {
            sm90::decode::dense::run_flash_splitkv_mla_kernel<cutlass::half_t, kHeadDimK>(params);
        });
#endif
    } else {
