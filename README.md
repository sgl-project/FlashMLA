...
DeepSeek V3.2 can also be run without the RoPE part (`head_dim` = 512, `kv_format="V32_NO_ROPE"`). The layout is the first 528 Bytes of the V3.2 row above: 512 Bytes of quantized NoPE followed by the 4 `float32` scale factors, and no RoPE part.
